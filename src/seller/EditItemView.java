...
public class EditItemView extends JFrame {
	...
	private static EditItemView frame;
	 ...
	 */
	public EditItemView(Product item) 
	{
		setTitle("Vapor");
		...
		JLabel lblnote = new JLabel("<html>*Note: Editing prices or quantity here will not affect current profit. ");
		lblnote.setVerticalAlignment(SwingConstants.TOP);
		lblnote.setBounds(25, 166, 96, 98);
		contentPane.add(lblnote);
		
		EditItemController controller = new EditItemController(this, item);
	}
	//Getters
	...
	public static EditItemView getFrame() 
	{
		return frame;
	}
}
